...
[v0.1.77](https://github.com/getrigeos/INVminer-Release/releases/tag/v0.1.77). Download
...
NOID accepts only WebPKI-verified TLS in v0.1.77. Plaintext Stratum/TCP,
...
v0.1.77 can apply the reviewed NVIDIA settings from the `invminer` command
...
Custom Miner package name. For v0.1.77, set:
