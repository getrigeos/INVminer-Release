...
[v0.1.56](https://github.com/getrigeos/INVminer-Release/releases/tag/v0.1.56). Download
...
NOID accepts only WebPKI-verified TLS in v0.1.56. Plaintext Stratum/TCP,
...
v0.1.56 can apply the reviewed NVIDIA settings from the `invminer` command
...
Custom Miner package name. For v0.1.56, set:

- Miner name: `invminer`
- Installation URL: `https://github.com/getrigeos/INVminer-Release/releases/download/v0.1.56/invminer-0.1.56.tar.gz`
- Hash algorithm: `noid`
